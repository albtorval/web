...
Si $\rho_{ij}^2 = 0$ significa que las variables $X_i$ y $X_j$ están incorreladas. Por el contrario, si $\rho_{ij}^2 = 1$ entonces existe una dependencia lineal entre ellas $(X_i = a + bX_j \quad a,b\in \mathbb{R})$. En forma matricial se tiene que $\mathbf{R} =  \Delta^{-1}\mathbf{\Sigma}\Delta^{-1}$ con $\Delta = diag\{\sigma_1,\cdots,\sigma_p\}$. 
...
$$max(\underline{t}_1' \mathbf{\Sigma} \underline{t}_1) \\ s.a.: \underline{t}_1'\underline{t}_1 = 1$$
...
$$max(\underline{t}_2' \mathbf{\Sigma} \underline{t}_2) \\ s.a.: \\ \underline{t}_2'\underline{t}_2 = 1 \\ \underline{t}_2' \mathbf{\Sigma} \underline{t}_1 = 0$$
...
$$max(\underline{t}_j' \mathbf{\Sigma} \underline{t}_j) \\ s.a.: \\ \underline{t}_j'\underline{t}_j = 1 \\ \underline{t}_j' \mathbf\Sigma \underline{t}_h = 0 \quad h = 1,...,j-1$$
